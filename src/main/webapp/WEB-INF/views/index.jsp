...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <a href="#sendinfo-menu" class="nav-header" data-toggle="collapse"><i class="icon-briefcase"></i>Sending Information<span class="label label-info">+3</span></a>
        <ul id="sendinfo-menu" class="nav nav-list collapse">
            <li ><a href="sign-in.html">Sending Status</a></li>
            <li ><a href="sign-up.html">Sent Trend</a></li>
        </ul>
